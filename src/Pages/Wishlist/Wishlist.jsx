...
const Wishlist = () => {
    ...
    const getData = () => {
        axios.get('https://664b52b135bbda10987c75d3.mockapi.io/quliyev/basket/wishlist')
        .then((res) => {
            setData(res.data)
        })
    }
    ...
    const removeItem = (id) => {
        axios.delete(`https://664b52b135bbda10987c75d3.mockapi.io/quliyev/basket/wishlist/${id}`)
        setTimeout(() => {
            getData()
        }, 400);
    }
